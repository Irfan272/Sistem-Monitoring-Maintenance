...
<head>
    ...
    <title>Maintenance | Manager MT</title>
...
<body>
    <div id="app">
        <div id="sidebar" class="active">
         @include('manager_MT.layout.partials.sidebar')
        </div>
        <div id="main" class='layout-navbar'>
          @include('manager_MT.layout.partials.nav')
            <div id="main-content">

               @yield('content')

           @include('manager_MT.layout.partials.footer')
            </div>
        </div>
    </div>
